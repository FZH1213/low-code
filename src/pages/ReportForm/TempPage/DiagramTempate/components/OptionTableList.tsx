...
const OptionTableList: React.FC<{}> = (props: any) => {
    ...
    // Table部分
    // const [tableTitle, setTableTitle] = useState<any>(undefined);
    ...
    return (
        <div style={{ height: props.moduleHeight ? props.moduleHeight : 400 }} bordered={false}>
            {//表格标题部分
