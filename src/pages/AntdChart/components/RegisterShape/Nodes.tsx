...
export default function (G6: any) {
    console.log('%c测试', 'color: white; background: red;', G6.Util)
    ...
    G6.registerNode('user-task-node', {
        options: G6.Util.deepMix({}, taskDefaultOptions, {
            icon: require('./icons/icon_user.svg'),
            style: {
                fill: '#E7F7FE',
                stroke: '#1890FF',
            },
    ...
    G6.registerNode('script-task-node', {
        options: G6.Util.deepMix({}, taskDefaultOptions, {
            icon: require('./icons/icon_script.svg'),
            style: {
                fill: '#FFF7E6',
                stroke: '#FFA940',
            },
    ...
    G6.registerNode('java-task-node', {
        options: G6.Util.deepMix({}, taskDefaultOptions, {
            icon: require('./icons/icon_java.svg'),
            style: {
                fill: '#FFF1F0',
                stroke: '#FF4D4F',
            },
    ...
    G6.registerNode('mail-task-node', {
        options: G6.Util.deepMix({}, taskDefaultOptions, {
            icon: require('./icons/icon_mail.svg'),
            style: {
                fill: '#F6FFED',
                stroke: '#73D13D',
            },
    ...
    G6.registerNode('receive-task-node', {
        options: G6.Util.deepMix({}, taskDefaultOptions, {
            icon: require('./icons/icon_receive.svg'),
            style: {
                fill: '#FFF0F6',
                stroke: '#FF85C0',
            },
    ...
    G6.registerNode('timer-start-node', {
        options: G6.Util.deepMix({}, startDefaultOptions, { icon: require('./icons/icon_timer.svg') }),
        afterDraw(cfg, group) { this.runAnimate(cfg, group) },
    }, 'start-node');
    G6.registerNode('message-start-node', {
        options: G6.Util.deepMix({}, startDefaultOptions, { icon: require('./icons/icon_message.svg') }),
        afterDraw(cfg, group) { this.runAnimate(cfg, group) },
    }, 'start-node');
    G6.registerNode('signal-start-node', {
        options: G6.Util.deepMix({}, startDefaultOptions, { icon: require('./icons/icon_signal.svg') }),
        afterDraw(cfg, group) { this.runAnimate(cfg, group) },
    }, 'start-node');
    G6.registerNode('timer-catch-node', {
        options: G6.Util.deepMix({}, catchDefaultOptions, { icon: require('./icons/icon_timer.svg') }),
    }, 'catch-node');
    G6.registerNode('signal-catch-node', {
        options: G6.Util.deepMix({}, catchDefaultOptions, { icon: require('./icons/icon_signal.svg') }),
    }, 'catch-node');
    G6.registerNode('message-catch-node', {
        options: G6.Util.deepMix({}, catchDefaultOptions, { icon: require('./icons/icon_message.svg') }),
    }, 'catch-node');
}
